...
FactoryBot.define do
  factory :tracked_sku do
    ...
    publication_date Faker::Date.backward(100)
    title Faker::Book.title
    author Faker::Book.author
    publisher Faker::Book.publisher
    binding Faker::Lorem.characters(5)
    condition Faker::Lorem.characters(5)
    location Faker::Lorem.characters(5)
    sku Faker::Lorem.characters(10)
    locator_code Faker::Lorem.characters(10)
    suffix Faker::Lorem.characters(10)
