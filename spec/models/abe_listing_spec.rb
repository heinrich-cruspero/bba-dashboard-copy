...
RSpec.describe AbeListing, type: :model do
  ...
  it 'is valid with valid attributes' do
    expect(AbeListing.new(abe_order: abe_order, listing_id: Faker::Number.number(10), quantity: Faker::Number.digit,
                          title: Faker::Book.title, isbn: Faker::Code, vendor_id: Faker::Number.number(10),
  ...
  it 'is not valid with no abe_order' do
    expect(AbeListing.new(listing_id: Faker::Number.number(10), quantity: Faker::Number.digit,
                          title: Faker::Book.title, isbn: Faker::Code, vendor_id: Faker::Number.number(10),
  ...
  it 'is not valid with no quantity' do
    expect(AbeListing.new(abe_order: abe_order, listing_id: Faker::Number.number(10),
                          title: Faker::Book.title, isbn: Faker::Code, vendor_id: Faker::Number.number(10),
                          min_shipping_days: Faker::Number.digit, max_shipping_days: Faker::Number.digit)).to_not be_valid
  end
  ...
  it 'is not valid with no title' do
    expect(AbeListing.new(abe_order: abe_order, listing_id: Faker::Number.number(10), quantity: Faker::Number.digit,
                          isbn: Faker::Code, vendor_id: Faker::Number.number(10),
                          min_shipping_days: Faker::Number.digit, max_shipping_days: Faker::Number.digit)).to_not be_valid
  end

  it 'is not valid with no isbn' do
    expect(AbeListing.new(abe_order: abe_order, listing_id: Faker::Number.number(10), quantity: Faker::Number.digit,
                          title: Faker::Book.title, vendor_id: Faker::Number.number(10),
                          min_shipping_days: Faker::Number.digit, max_shipping_days: Faker::Number.digit)).to_not be_valid
  end
